@include('pages.user-access-item.js')
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <div class="mb-3">
                        <h5>Kelola Akses Pengguna</h5>
                        <div class="form-text">Kelola akses aplikasi di sini.</div>
                    </div>

                    <div class="w-100 d-flex justify-content-between align-items-center">
                        <!-- Create Modal -->
                        @if (check_user_access('user-access-item', 'create'))
                            <div>
                                ...
                                <div class="modal-dialog">
                                    <form id="create-form" method="post" class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0" id="myModalLabel">Tambah Akses</h5>
