<script>
    $(function() {
                ...
                },
                {
                    ...
                    render: (m, t, data) => {
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-1">
                            ${accessUpdate ? `
                            <a href="{{ url('#packet-product') }}/${data.id}">
                                <button data-id="${data.id}" title="Kelola Menu" class="edit-btn btn btn-success btn-sm">
        ...
        $('#create-btn').on('click', function() {
            $('#add-modal').find('.modal-body').load('{{ route('packet.create') }}')
        })
        ...
        $('#edit-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                beforeSend: () => {
                    ...
                    /* Reset Error */
                    $('#category_id-edit-error').text('')
                    $('#name-edit-error').text('')
                    $('#image-edit-error').text('')
                    $('#order_number-edit-error').text('')
                },
                complete: () => {
