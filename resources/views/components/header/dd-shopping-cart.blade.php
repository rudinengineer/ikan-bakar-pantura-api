...
<div class="offcanvas offcanvas-end shopping-cart" tabindex="-1" id="offcanvasRight"
  ...
  <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
    <ul class="mb-0">
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img src="{{ url('assets/images/products/product-1.jpg') }}" width="95" height="75"
      ...
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img src="{{ url('assets/images/products/product-2.jpg') }}" width="95" height="75"
            class="rounded-1 me-9 flex-shrink-0" alt="modernize-img" />
          <div>
            <h6 class="mb-1">Supreme toys cooker</h6>
            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
      ...
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img src="{{ url('assets/images/products/product-3.jpg') }}" width="95" height="75"
            class="rounded-1 me-9 flex-shrink-0" alt="modernize-img" />
          <div>
            <h6 class="mb-1">Supreme toys cooker</h6>
            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
    ...
    <div class="align-bottom">
      ...
      <a href="/main/eco-checkout" class="btn btn-outline-primary w-100">Go to shopping cart</a>
    </div>
  </div>
</div>